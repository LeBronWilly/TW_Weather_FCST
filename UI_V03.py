...
################################################################################
## Form generated from reading UI file 'TW_Weather_FCST_UI_V03IdBcsA.ui'
##
...
class Ui_TW_Weather_FCST(object):
    def setupUi(self, TW_Weather_FCST):
        ...
        TW_Weather_FCST.resize(1841, 833)
        self.Refresh_Button = QPushButton(TW_Weather_FCST)
        self.Refresh_Button.setObjectName(u"Refresh_Button")
        self.Refresh_Button.setEnabled(True)
        self.Refresh_Button.setGeometry(QRect(690, 770, 201, 41))
        font = QFont()
        ...
        self.WillyF_Label.setGeometry(QRect(10, 800, 411, 31))
        font2 = QFont()
        ...
        self.Pic_Label.setGeometry(QRect(1730, 50, 80, 80))
        ...
        self.Location_ComboBox.setGeometry(QRect(320, 40, 351, 41))
        font3 = QFont()
        ...
        self.List_Label_2.setGeometry(QRect(850, 40, 301, 41))
        ...
        self.label_4.setGeometry(QRect(30, 190, 411, 41))
        font5 = QFont()
        ...
        self.Period_ComboBox.setGeometry(QRect(320, 260, 351, 41))
        ...
        self.List_Label_4.setGeometry(QRect(850, 100, 351, 41))
        ...
        self.Field_Desc_Table.setGeometry(QRect(850, 150, 961, 71))
        font6 = QFont()
        ...
        self.Info_Table_2.setGeometry(QRect(30, 449, 1781, 311))
