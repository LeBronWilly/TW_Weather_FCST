...
################################################################################
## Form generated from reading UI file 'TW_Weather_FCST_UI_V03DnrnBy.ui'
##
...
class Ui_TW_Weather_FCST(object):
    def setupUi(self, TW_Weather_FCST):
        ...
        TW_Weather_FCST.resize(1841, 881)
        self.Refresh_Button = QPushButton(TW_Weather_FCST)
        self.Refresh_Button.setObjectName(u"Refresh_Button")
        self.Refresh_Button.setEnabled(True)
        self.Refresh_Button.setGeometry(QRect(690, 830, 201, 41))
        font = QFont()
        ...
        self.List_Label.setGeometry(QRect(30, 50, 301, 41))
        font1 = QFont()
        ...
        self.WillyF_Label.setGeometry(QRect(10, 850, 411, 31))
        font2 = QFont()
        ...
        self.Pic_Label.setGeometry(QRect(1730, 30, 80, 80))
        ...
        self.Location_ComboBox.setGeometry(QRect(320, 50, 351, 41))
        font3 = QFont()
        ...
        self.List_Label_2.setGeometry(QRect(850, 20, 301, 41))
        ...
        self.label_4.setGeometry(QRect(30, 170, 411, 41))
        font5 = QFont()
        ...
        self.Search_Button.setGeometry(QRect(370, 140, 251, 41))
        self.Search_Button.setFont(font)
        self.Update_Time_Label = QLabel(TW_Weather_FCST)
        self.Update_Time_Label.setObjectName(u"Update_Time_Label")
        self.Update_Time_Label.setGeometry(QRect(1400, 850, 411, 31))
        ...
        self.List_Label_4.setGeometry(QRect(850, 80, 351, 41))
        ...
        self.Field_Desc_Table.setGeometry(QRect(850, 130, 961, 71))
        font6 = QFont()
        font6.setPointSize(9)
        self.Field_Desc_Table.setFont(font6)
        ...
        self.Info_Table_2 = QTableWidget(TW_Weather_FCST)
        self.Info_Table_2.setObjectName(u"Info_Table_2")
        self.Info_Table_2.setGeometry(QRect(30, 439, 1781, 381))
    ...
    def retranslateUi(self, TW_Weather_FCST):
        ...
        self.WillyF_Label.setText(QCoreApplication.translate("TW_Weather_FCST", u"Developed by WillyF (w70024@gmail.com)", None))
        ...
        self.List_Label_2.setText(QCoreApplication.translate("TW_Weather_FCST", u"Region Filter:", None))
